...
void Vcounter_8bit___024root__trace_chg_0_sub_0(Vcounter_8bit___024root* vlSelf, VerilatedFst::Buffer* bufp);

void Vcounter_8bit___024root__trace_chg_0(void* voidSelf, VerilatedFst::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcounter_8bit___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vcounter_8bit___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vcounter_8bit___024root__trace_chg_0_sub_0(Vcounter_8bit___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcounter_8bit___024root__trace_chg_0_sub_0\n"); );
    Vcounter_8bit__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
void Vcounter_8bit___024root__trace_cleanup(void* voidSelf, VerilatedFst* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcounter_8bit___024root__trace_cleanup\n"); );
    // Init
    Vcounter_8bit___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vcounter_8bit___024root*>(voidSelf);
    Vcounter_8bit__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
